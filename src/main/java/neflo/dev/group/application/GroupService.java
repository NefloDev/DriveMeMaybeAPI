package neflo.dev.group.application;

import jakarta.transaction.Transactional;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import neflo.dev.group.api.*;
...
import neflo.dev.shared.dto.YearMonth;
...
import neflo.dev.shared.persistence.JDBCRepository;
import neflo.dev.trip.api.TripRequestDTO;
import neflo.dev.trip.infrastructure.mapper.TripMapper;
...
public class GroupService {
    ...
    public GroupInsights getGroupInsights(UUID userUuid, UUID groupUuid, GroupInsightsRequest groupInsightsRequest) {
        ...
        GroupInsights response = switch (groupInsightsRequest.periodType()) {
            ...
            case MONTHLY ->
                    jdbcRepository.getMonthlyGroupInsights(groupUuid, YearMonth.of(groupInsightsRequest.year(), groupInsightsRequest.month()));
        };
